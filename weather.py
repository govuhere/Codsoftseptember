...
w_label=Label(win,text="Weather Description",background="skyblue",foreground="black",
                font=("Arial",15))
...
h_label=Label(win,text="Humidity ",background="skyblue",foreground="black",
                font=("Arial",15))
h_label.place(x=25,y=350,height=30,width=200)
